...
void permutation(BoolIO<StdIO> *ios[threads], int party) {
  ...
  if (party == ALICE) {
    vec1 = {266026097440677721ULL, 849770927124998457ULL, 999529119469216130ULL, 1185230980869603820ULL, 100309634411137914ULL, 1585587853683462547ULL, 715103118122429764ULL, 509808212382101629ULL, 1194065923955419311ULL, 1774258671455680259ULL};
    vec2 = {715103118122429764ULL, 999529119469216130ULL, 1774258671455680259ULL, 1585587853683462547ULL, 100309634411137914ULL, 849770927124998457ULL, 266026097440677721ULL, 1194065923955419311ULL, 509808212382101629ULL, 1185230980869603820ULL};
  }
